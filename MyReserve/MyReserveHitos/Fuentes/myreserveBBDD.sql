DROP DATABASE IF EXISTS MyReserve;
GO
...
CREATE TABLE Usuarios (
    usu_id INT IDENTITY(1,1) PRIMARY KEY, -- ID creciente
    usu_nombre VARCHAR(255) NOT NULL, -- Nombre del Usuario
    usu_correo_electronico VARCHAR(255) UNIQUE NOT NULL, -- Correo Electronico ÚNICO por usuario
    usu_contrasenha VARCHAR(255) NOT NULL, -- Contraseña por usuario,
);
...
INSERT Servicios(ser_nombre, ser_precio, ser_cat_id_fk) VALUES -- Plantilla por defecto de servicios para las peluquerías
	...
	('Corte de pelo', 16, 1),
	('Afeitado & Barba', 23, 1),
	('Afeitado Maquina', 13, 1),
	('Arreglo Barba', 13, 2),
	('Afeitado SPA', 13, 2),
	('Corte Barba con Maquina', 7, 2),
	('Tinte', 20, 3),
	('Tinte Express', 15, 3),
	('Decoloración', 50, 3),
	('Matíz', 10, 3),
	('Manicura Básica', 10, 4),
	('Manicura Rusa', 10, 4),
	('Uñas Acrílicas', 10, 4),
	('Manicura Inmesion', 10, 4),
	('Decoración Uña', 2, 4),
	('Decoración Todas las uñas', 8, 4),
	('Depilacion Cejas', 9, 5),
	('Depilación Oidos/Entrecejo/Labios', 5, 5),
	('Depilación Rostro Completo', 25, 5),
	('Depilación Corporal', 45, 5),
	('Mechas', 45, 5),
	('Pedicura Hombres', 14, 7),
	('Pedicura Mujeres', 14, 7),
	('Pedicura Express', 20, 7),
	('Pedicura Completa SPA', 45, 7);

INSERT INTO Horarios (hora_id, hora_fecha) VALUES 
    (1, '08:30'),
    (2, '09:00'),
    (3, '09:30'),
    (4, '10:00'),
...
INSERT Region (reg_id, reg_pai_id_fk, reg_nombre) VALUES -- Tabla por defecto de las regiones
    ...
    (781, 55, 'Delaware'),
    (782, 55, 'Florida'),
    (783, 55, 'Federated Statess of Micronesia'),
    (784, 55, 'Georgia'),
    (786, 55, 'Hawaii'),
    (787, 55, 'Iowa'),
    (788, 55, 'Idaho'),
...
INSERT Region (reg_id, reg_pai_id_fk, reg_nombre) VALUES 
    ...
    (1667, 81, 'Bío-Bío'),
    (1668, 81, 'Coquimbo'),
    (1669, 81, 'Libertador General Bernardo OHiggins'),
    (1670, 81, 'Los Lagos'),
